...
const chat_content_message_text_1 = __webpack_require__(367);
const chat_content_message_post_1 = __webpack_require__(368);
const chat_content_message_img_1 = __webpack_require__(369);
const chat_content_message_file_1 = __webpack_require__(370);
const chat_content_message_system_1 = __webpack_require__(371);
const chat_content_input_1 = __webpack_require__(356);
const chat_user_state_1 = __webpack_require__(372);
let ChatContentPageModule = class ChatContentPageModule {
};
ChatContentPageModule = __decorate([
    core_1.NgModule({
        declarations: [
            chat_content_1.ChatContentComponent,
            chat_content_message_text_1.ChatContentMessageTextComponent,
            chat_content_message_post_1.ChatContentMessagePostComponent,
            chat_content_message_img_1.ChatContentMessageImgComponent,
            chat_content_message_file_1.ChatContentMessageFileComponent,
            chat_content_message_system_1.ChatContentMessageSystemComponent,
            chat_content_input_1.ChatContentInputComponent,
            chat_user_state_1.ChatUserStateComponent
        ],
        exports: [
            chat_content_message_text_1.ChatContentMessageTextComponent,
            chat_content_message_post_1.ChatContentMessagePostComponent,
        ...
        imports: [
            ionic_angular_1.IonicPageModule.forChild(chat_content_1.ChatContentComponent),
        ],
    })
], ChatContentPageModule);
exports.ChatContentPageModule = ChatContentPageModule;
...
const chat_content_module_1 = __webpack_require__(315);
let ChatContentMessageDetailComponentModule = class ChatContentMessageDetailComponentModule {
};
ChatContentMessageDetailComponentModule = __decorate([
    core_1.NgModule({
        declarations: [
            chat_content_message_detail_1.ChatContentMessageDetailComponent,
        ],
        imports: [
            chat_content_module_1.ChatContentPageModule,
            ionic_angular_1.IonicPageModule.forChild(chat_content_message_detail_1.ChatContentMessageDetailComponent),
        ],
    })
], ChatContentMessageDetailComponentModule);
exports.ChatContentMessageDetailComponentModule = ChatContentMessageDetailComponentModule;
//# sourceMappingURL=chat-content-message-detail.module.js.map
 ...
 * Components.
 */
let ChatContentMessageTextComponent = class ChatContentMessageTextComponent {
    constructor(appConfig, typeService) {
        this.appConfig = appConfig;
        this.typeService = typeService;
        this.originalMessageObj = {};
        this.userConfig = UserConfig;
    }
    set setMessage(param) {
        if (param) {
            this.messageObj = param;
        }
    }
    //是否是转发消息
    set setIsForward(bool) {
        this.isForwardMessage = bool;
    }
    //所有参与群聊的成员信息
    set setAllUserInfo(param) {
     ...
     * 获取原始消息的owner info
     */
    getOriginalMessageOwnerInfo(originalMessage) {
     ...
     * - 换行"\n"
     */
    analyseMessageText(message, userInfoArr) {
        if (message.msg && !message.safeMsg) {
            ...
            if (userInfoArr) {
                ...
                messageText = messageText.replace(findReg, function (rs, $1, $2, $3, $4) {
                    let str = rs;
...
__decorate([
    ...
    __metadata("design:type", Object),
    __metadata("design:paramtypes", [Object])
], ChatContentMessageTextComponent.prototype, "setMessage", null);
__decorate([
    core_1.Input(),
    __metadata("design:type", Boolean),
    __metadata("design:paramtypes", [Boolean])
], ChatContentMessageTextComponent.prototype, "setIsForward", null);
__decorate([
    core_1.Input(),
    __metadata("design:type", Object),
    __metadata("design:paramtypes", [Object])
], ChatContentMessageTextComponent.prototype, "setAllUserInfo", null);
__decorate([
    core_1.Input(),
    __metadata("design:type", Object),
    __metadata("design:paramtypes", [Object])
], ChatContentMessageTextComponent.prototype, "setChannelInfo", null);
ChatContentMessageTextComponent = __decorate([
    core_1.Component({
        selector: 'chat-content-message-text',template:/*ion-inline-start:"/Users/zhouhuan/Documents/work/blockbi-app/src/pages/chat-content/chat-content-message-text/chat-content-message-text.html"*/'<!-- Generated template for the ChatContentMessageTextComponent component -->\n<div class="common-message" *ngIf="messageObj"\n     [class.self-message]="messageObj?.isSelf"\n     [class.other-message]="!messageObj?.isSelf"\n>\n    <img class="user-avatar"\n         src="{{messageObj?.user_info?.user_profile_path? appConfig.resourceDomain+messageObj?.user_info?.user_profile_path:\'\'}}">\n    <div class="user-name">\n        <span>{{messageObj?.user_info?.work_name}}</span>\n        <!--<span class="bi-icon-resume user-state"></span>-->\n        <chat-user-state\n                *ngIf="channelInfo.form == userConfig.USER_FORM_COMPANY"\n                [setUserState]="messageObj?.user_info">\n        </chat-user-state>\n        <span class="message-time">{{messageObj?.date_time}}</span>\n    </div>\n    <div class="message-text" *ngIf="!isForwardMessage" [innerHTML]="messageObj.safeMsg">\n        <!--{{messageObj?.msg}}-->\n    </div>\n    <div *ngIf="isForwardMessage">\n        <div class="message-text">\n            <span>Forward</span>\n        </div>\n        <div class="forward-message-owner">\n            <span class="bi-icon-forward"></span>\n            <img src="{{originalMessageOwner?.user_profile_path? appConfig.resourceDomain + originalMessageOwner?.user_profile_path:\'\'}}">\n            <span class="forward-message-name">{{originalMessageOwner?.work_name}}</span>\n        </div>\n        <div class="forward-message-text">\n            <span [innerHTML]="originalMessageObj.safeMsg"></span>\n        </div>\n    </div>\n</div>\n'/*ion-inline-end:"/Users/zhouhuan/Documents/work/blockbi-app/src/pages/chat-content/chat-content-message-text/chat-content-message-text.html"*/
    }),
    __param(0, core_1.Inject('app.config')),
    __param(1, core_1.Inject('type.service')),
    __metadata("design:paramtypes", [Object, Object])
], ChatContentMessageTextComponent);
exports.ChatContentMessageTextComponent = ChatContentMessageTextComponent;
//# sourceMappingURL=chat-content-message-text.js.map
 ...
 * Components.
 */
let ChatContentMessagePostComponent = class ChatContentMessagePostComponent {
...
__decorate([
    ...
    __metadata("design:type", Object),
    __metadata("design:paramtypes", [Object])
], ChatContentMessagePostComponent.prototype, "setMessage", null);
__decorate([
    core_1.Input(),
    __metadata("design:type", Boolean),
    __metadata("design:paramtypes", [Boolean])
], ChatContentMessagePostComponent.prototype, "setIsForward", null);
__decorate([
    core_1.Input(),
    __metadata("design:type", Boolean),
    __metadata("design:paramtypes", [Boolean])
], ChatContentMessagePostComponent.prototype, "setIsShare", null);
__decorate([
    core_1.Input(),
    __metadata("design:type", Object),
    __metadata("design:paramtypes", [Object])
], ChatContentMessagePostComponent.prototype, "setAllUserInfo", null);
ChatContentMessagePostComponent = __decorate([
    core_1.Component({
        selector: 'chat-content-message-post',template:/*ion-inline-start:"/Users/zhouhuan/Documents/work/blockbi-app/src/pages/chat-content/chat-content-message-post/chat-content-message-post.html"*/'<!-- Generated template for the ChatContentMessagePostComponent component -->\n<div class="post-message" *ngIf="messageObj"\n     [class.self-message]="messageObj?.isSelf"\n     [class.other-message]="!messageObj?.isSelf"\n>\n    <img class="user-avatar"\n         src="{{messageObj?.user_info?.user_profile_path? appConfig.resourceDomain+messageObj?.user_info?.user_profile_path:\'\'}}">\n    <div class="user-name">\n        <span>{{messageObj?.user_info?.work_name}}</span>\n        <span class="bi-icon-resume user-state"></span>\n        <span class="message-time">{{messageObj?.date_time}}</span>\n    </div>\n    <div class="file-name">\n        <span>{{isShareMessage?\'share\' : isForwardMessage? \'Forward\':\'Post\'}}</span>\n    </div>\n    <div class="post-content"    *ngIf="!isForwardMessage">\n        <div class="message-file">\n            <span class="file-icon file-icon-post"></span>\n            <div class="file-info">\n                <p>{{fileDetail?.post_name}}</p>\n                <p>Last comments 20:00 20th JUL</p>\n            </div>\n        </div>\n        <div class="post-summary">\n            <span>\n            {{fileDetail?.summary}}\n            </span>\n        </div>\n        <div class="first_attachment" *ngIf="fileDetail?.first_attachment?.path">\n            <img src="{{fileDetail?.first_attachment?.path? appConfig.resourceDomain+fileDetail?.first_attachment?.path:\'\'}}">\n        </div>\n    </div>\n\n    <div class="post-content post-forward" *ngIf="isForwardMessage">\n        <div class="forward-message-owner">\n            <span class="bi-icon-forward"></span>\n            <img src="{{originalMessageOwner?.user_profile_path? appConfig.resourceDomain + originalMessageOwner?.user_profile_path:\'\'}}">\n            <div class="user-name">\n                <span>{{originalMessageOwner?.work_name}}</span>\n            </div>\n            <div class="file-name">\n                <span>Post</span>\n            </div>\n        </div>\n            <div class="message-file">\n                <span class="file-icon file-icon-post"></span>\n                <div class="file-info">\n                    <p>{{originalMessageObj?.detail?.post_name}}</p>\n                    <p>Last comments 20:00 20th JUL</p>\n                </div>\n            </div>\n            <div class="post-summary">\n                <span>\n                {{originalMessageObj?.detail?.summary}}\n                </span>\n            </div>\n            <div class="first_attachment" *ngIf="originalMessageObj?.detail?.first_attachment?.path">\n                <img src="{{originalMessageObj?.detail?.first_attachment?.path? appConfig.resourceDomain+originalMessageObj?.detail?.first_attachment?.path:\'\'}}">\n            </div>\n    </div>\n</div>\n'/*ion-inline-end:"/Users/zhouhuan/Documents/work/blockbi-app/src/pages/chat-content/chat-content-message-post/chat-content-message-post.html"*/
    }),
    __param(0, core_1.Inject('app.config')),
    __metadata("design:paramtypes", [Object])
], ChatContentMessagePostComponent);
exports.ChatContentMessagePostComponent = ChatContentMessagePostComponent;
//# sourceMappingURL=chat-content-message-post.js.map
 ...
 * Components.
 */
let ChatContentMessageImgComponent = class ChatContentMessageImgComponent {
    constructor(appConfig) {
        this.appConfig = appConfig;
    }
    set setMessage(param) {
...
__decorate([
    ...
    __metadata("design:type", Object),
    __metadata("design:paramtypes", [Object])
], ChatContentMessageImgComponent.prototype, "setMessage", null);
__decorate([
    core_1.Input(),
    __metadata("design:type", Boolean),
    __metadata("design:paramtypes", [Boolean])
], ChatContentMessageImgComponent.prototype, "setIsForward", null);
__decorate([
    core_1.Input(),
    __metadata("design:type", Boolean),
    __metadata("design:paramtypes", [Boolean])
], ChatContentMessageImgComponent.prototype, "setIsShare", null);
__decorate([
    core_1.Input(),
    __metadata("design:type", Object),
    __metadata("design:paramtypes", [Object])
], ChatContentMessageImgComponent.prototype, "setAllUserInfo", null);
ChatContentMessageImgComponent = __decorate([
    core_1.Component({
        selector: 'chat-content-message-img',template:/*ion-inline-start:"/Users/zhouhuan/Documents/work/blockbi-app/src/pages/chat-content/chat-content-message-img/chat-content-message-img.html"*/'<!-- Generated template for the ChatContentMessageImgComponent component -->\n<div class="img-message" *ngIf="messageObj"\n     [class.self-message]="messageObj?.isSelf"\n     [class.other-message]="!messageObj?.isSelf"\n>\n    <!--<ion-avatar no-padding no-margin>-->\n    <img class="user-avatar"\n         src="{{messageObj?.user_info?.user_profile_path? appConfig.resourceDomain+messageObj?.user_info?.user_profile_path:\'\'}}">\n    <div class="user-name">\n        <span>{{messageObj?.user_info?.work_name}}</span>\n        <span class="bi-icon-resume user-state"></span>\n        <span class="message-time">{{messageObj?.date_time}}</span>\n    </div>\n    <div class="file-name">\n        <span>{{isShareMessage?\'share\' : isForwardMessage? \'Forward\':\'Upload\'}}</span>\n        <span>{{messageObj?.detail?.file_name}}</span>\n    </div>\n    <!-------非转发消息-------->\n    <div class="message-image" *ngIf="!isForwardMessage">\n        <img src="{{appConfig.resourceDomain + messageObj?.detail?.file_path}}" alt="">\n    </div>\n    <!-------转发消息-------->\n    <div *ngIf="isForwardMessage">\n        <div class="forward-message-owner">\n            <span class="bi-icon-forward"></span>\n            <img src="{{originalMessageOwner?.user_profile_path? appConfig.resourceDomain + originalMessageOwner?.user_profile_path:\'\'}}">\n            <div class="user-name">\n                <span>{{originalMessageOwner?.work_name}}</span>\n            </div>\n            <div class="file-name">\n                <span>Upload</span>\n                <span>{{originalMessageObj?.detail?.file_name}}</span>\n            </div>\n        </div>\n        <div class="forward-message-text">\n            <img src="{{appConfig.resourceDomain + originalMessageObj?.detail?.file_path}}" alt="">\n        </div>\n    </div>\n</div>\n'/*ion-inline-end:"/Users/zhouhuan/Documents/work/blockbi-app/src/pages/chat-content/chat-content-message-img/chat-content-message-img.html"*/
    }),
    __param(0, core_1.Inject('app.config')),
    __metadata("design:paramtypes", [Object])
], ChatContentMessageImgComponent);
exports.ChatContentMessageImgComponent = ChatContentMessageImgComponent;
//# sourceMappingURL=chat-content-message-img.js.map
 ...
 * Components.
 */
let ChatContentMessageFileComponent = class ChatContentMessageFileComponent {
    constructor(appConfig) {
        this.appConfig = appConfig;
    }
    set setMessage(param) {
...
__decorate([
    ...
    __metadata("design:type", Object),
    __metadata("design:paramtypes", [Object])
], ChatContentMessageFileComponent.prototype, "setMessage", null);
__decorate([
    core_1.Input(),
    __metadata("design:type", Boolean),
    __metadata("design:paramtypes", [Boolean])
], ChatContentMessageFileComponent.prototype, "setIsForward", null);
__decorate([
    core_1.Input(),
    __metadata("design:type", Boolean),
    __metadata("design:paramtypes", [Boolean])
], ChatContentMessageFileComponent.prototype, "setIsShare", null);
__decorate([
    core_1.Input(),
    __metadata("design:type", Object),
    __metadata("design:paramtypes", [Object])
], ChatContentMessageFileComponent.prototype, "setAllUserInfo", null);
ChatContentMessageFileComponent = __decorate([
    core_1.Component({
        selector: 'chat-content-message-file',template:/*ion-inline-start:"/Users/zhouhuan/Documents/work/blockbi-app/src/pages/chat-content/chat-content-message-file/chat-content-message-file.html"*/'<!-- Generated template for the ChatContentMessageFileComponent component -->\n<div class="file-message" *ngIf="messageObj"\n     [class.self-message]="messageObj?.isSelf"\n     [class.other-message]="!messageObj?.isSelf"\n>\n    <!--<ion-avatar no-padding no-margin>-->\n    <img class="user-avatar"\n         src="{{messageObj?.user_info?.user_profile_path? appConfig.resourceDomain+messageObj?.user_info?.user_profile_path:\'\'}}">\n    <div class="user-name">\n        <span>{{messageObj?.user_info?.work_name}}</span>\n        <span class="bi-icon-resume user-state"></span>\n        <span class="message-time">{{messageObj?.date_time}}</span>\n    </div>\n    <div class="file-name">\n        <span>{{isShareMessage?\'share\' : isForwardMessage? \'Forward\':\'Upload\'}}</span>\n    </div>\n    <!-------非转发消息-------->\n    <div class="message-file" *ngIf="!isForwardMessage">\n        <span class="file-icon file-icon-{{fileDetail?.file_type}}"></span>\n        <div class="file-info">\n            <p>{{fileDetail?.file_name}}</p>\n            <p>3MB</p>\n        </div>\n    </div>\n    <!-------转发消息-------->\n    <div *ngIf="isForwardMessage">\n        <div class="forward-message-owner">\n            <span class="bi-icon-forward"></span>\n            <img src="{{originalMessageOwner?.user_profile_path? appConfig.resourceDomain + originalMessageOwner?.user_profile_path:\'\'}}">\n            <div class="user-name">\n                <span>{{originalMessageOwner?.work_name}}</span>\n            </div>\n            <div class="file-name">\n                <span>Upload</span>\n            </div>\n        </div>\n        <div class="forward-message-text">\n            <span class="file-icon file-icon-{{originalMessageObj?.detail?.file_type}}"></span>\n            <div class="file-info">\n                <p>{{originalMessageObj?.detail?.file_name}}</p>\n                <p>3MB</p>\n            </div>\n        </div>\n    </div>\n\n\n</div>\n'/*ion-inline-end:"/Users/zhouhuan/Documents/work/blockbi-app/src/pages/chat-content/chat-content-message-file/chat-content-message-file.html"*/
    }),
    __param(0, core_1.Inject('app.config')),
    __metadata("design:paramtypes", [Object])
], ChatContentMessageFileComponent);
exports.ChatContentMessageFileComponent = ChatContentMessageFileComponent;
//# sourceMappingURL=chat-content-message-file.js.map
 ...
 * Components.
 */
let ChatContentMessageSystemComponent = class ChatContentMessageSystemComponent {
    constructor(appConfig) {
        this.appConfig = appConfig;
    }
    set setMessage(param) {
...
__decorate([
    ...
    __metadata("design:type", Object),
    __metadata("design:paramtypes", [Object])
], ChatContentMessageSystemComponent.prototype, "setMessage", null);
ChatContentMessageSystemComponent = __decorate([
    core_1.Component({
        selector: 'chat-content-message-system',template:/*ion-inline-start:"/Users/zhouhuan/Documents/work/blockbi-app/src/pages/chat-content/chat-content-message-system/chat-content-message-system.html"*/'<!-- Generated template for the ChatContentMessageSystemComponent component -->\n<div *ngIf="messageObj" class="system-message">\n  <div  *ngIf="messageObj?.detail?.act_type === 7">\n    <img class="user-avatar"\n         src="{{messageObj?.user_info?.user_profile_path? appConfig.resourceDomain+messageObj?.user_info?.user_profile_path:\'\'}}">\n    <div class="user-name">\n      <span>{{messageObj?.user_info?.work_name}}</span>\n      <span class="bi-icon-resume user-state"></span>\n      <span class="message-time">{{messageObj?.date_time}}</span>\n    </div>\n    <div class="file-name">\n      <span>comments on</span>\n      <span>{{messageObj?.detail?.file_info?.file_name}}</span>\n    </div>\n    <div class="comments-text">\n      <span class="bi-icon-comments"></span>\n      <span class="comments-text-message">{{messageObj?.detail?.commentTxt}}</span>\n    </div>\n  </div>\n</div>\n'/*ion-inline-end:"/Users/zhouhuan/Documents/work/blockbi-app/src/pages/chat-content/chat-content-message-system/chat-content-message-system.html"*/
    }),
    __param(0, core_1.Inject('app.config')),
    __metadata("design:paramtypes", [Object])
], ChatContentMessageSystemComponent);
exports.ChatContentMessageSystemComponent = ChatContentMessageSystemComponent;
//# sourceMappingURL=chat-content-message-system.js.map
 ...
 * Components.
 */
let ChatUserStateComponent = class ChatUserStateComponent {
    constructor() {
        this.userConfig = UserConfig;
        console.log('Hello ChatUserStateComponent Component');
        this.text = 'Hello World';
    }
    set setUserState(param) {
        if (param) {
            this.userInfo = param;
...
__decorate([
    ...
    __metadata("design:type", Object),
    __metadata("design:paramtypes", [Object])
], ChatUserStateComponent.prototype, "setUserState", null);
ChatUserStateComponent = __decorate([
    core_1.Component({
        selector: 'chat-user-state',template:/*ion-inline-start:"/Users/zhouhuan/Documents/work/blockbi-app/src/pages/chat-content/chat-user-state/chat-user-state.html"*/'<!-- Generated template for the ChatUserStateComponent component -->\n<div [ngSwitch]="userState">\n    <span class="bi-icon-business-travel"  *ngSwitchCase="userConfig.USER_SHOW_STATE_BUSINESS_TRAVEL">\n                <span class="path1"></span>\n                <span class="path2"></span>\n                <span class="path3"></span>\n                <span class="path4"></span>\n                <span class="path5"></span>\n                <span class="path6"></span>\n                <span class="path7"></span>\n                <span class="path8"></span>\n                <span class="path9"></span>\n                <span class="path10"></span>\n                <span class="path11"></span>\n                <span class="path12"></span>\n                <span class="path13"></span>\n                <span class="path14"></span>\n                <span class="path15"></span>\n                <span class="path16"></span>\n                <span class="path17"></span>\n                <span class="path18"></span>\n  </span>\n    <span class="bi-icon-in-work"  *ngSwitchCase="userConfig.USER_SHOW_STATE_IN_WORKING">\n                <span class="path1"></span>\n                <span class="path2"></span>\n                <span class="path3"></span>\n                <span class="path4"></span>\n                <span class="path5"></span>\n                <span class="path6"></span>\n                <span class="path7"></span>\n                <span class="path8"></span>\n                <span class="path9"></span>\n                <span class="path10"></span>\n                <span class="path11"></span>\n                <span class="path12"></span>\n                <span class="path13"></span>\n                <span class="path14"></span>\n                <span class="path15"></span>\n                <span class="path16"></span>\n                <span class="path17"></span>\n                <span class="path18"></span>\n                <span class="path19"></span>\n    </span>\n    <span class="bi-icon-vacation"  *ngSwitchCase="userConfig.USER_SHOW_STATE_VACATION">\n                <span class="path1"></span>\n                <span class="path2"></span>\n                <span class="path3"></span>\n                <span class="path4"></span>\n                <span class="path5"></span>\n                <span class="path6"></span>\n                <span class="path7"></span>\n                <span class="path8"></span>\n         </span>\n    <span class="bi-icon-in-meeting" *ngSwitchCase="userConfig.USER_SHOW_STATE_IN_MEETING">\n                <span class="path1"></span>\n                <span class="path2"></span>\n                <span class="path3"></span>\n                <span class="path4"></span>\n                <span class="path5"></span>\n                <span class="path6"></span>\n                <span class="path7"></span>\n                <span class="path8"></span>\n                <span class="path9"></span>\n                <span class="path10"></span>\n                <span class="path11"></span>\n                <span class="path12"></span>\n                <span class="path13"></span>\n                <span class="path14"></span>\n                <span class="path15"></span>\n                <span class="path16"></span>\n                <span class="path17"></span>\n                <span class="path18"></span>\n                <span class="path19"></span>\n                <span class="path20"></span>\n                <span class="path21"></span>\n                <span class="path22"></span>\n    </span>\n</div>\n'/*ion-inline-end:"/Users/zhouhuan/Documents/work/blockbi-app/src/pages/chat-content/chat-user-state/chat-user-state.html"*/
    }),
    __metadata("design:paramtypes", [])
], ChatUserStateComponent);
exports.ChatUserStateComponent = ChatUserStateComponent;
//# sourceMappingURL=chat-user-state.js.map
