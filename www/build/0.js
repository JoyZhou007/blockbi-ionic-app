...
const contact_details_1 = __webpack_require__(379);
const contact_company_intro_1 = __webpack_require__(380);
const contact_company_analysis_1 = __webpack_require__(381);
const contact_personal_analysis_1 = __webpack_require__(382);
const contact_resume_1 = __webpack_require__(383);
const contact_general_1 = __webpack_require__(384);
...
ContactDetailsPageModule = __decorate([
    core_1.NgModule({
        declarations: [
            contact_details_1.ContactDetailsPage,
            contact_general_1.ContactGeneralComponent,
            contact_company_intro_1.ContactCompanyIntroComponent,
            contact_company_analysis_1.ContactCompanyAnalysisComponent,
            contact_personal_analysis_1.ContactPersonalAnalysisComponent,
            contact_resume_1.ContactResumeComponent,
        ],
        imports: [
            ionic_angular_1.IonicPageModule.forChild(contact_details_1.ContactDetailsPage),
            shared_module_1.SharedModule
        ],
    })
], ContactDetailsPageModule);
exports.ContactDetailsPageModule = ContactDetailsPageModule;
...
let ContactDetailsPage = class ContactDetailsPage {
    ...
    constructor(navCtrl, events, navParams, viewCtrl, userModelService, modalCtrl, userStoreService, appConfig, userService, fileService) {
        this.navCtrl = navCtrl;
        this.events = events;
        this.navParams = navParams;
        ...
        if (this.navParams.data) {
            ...
            if (this.userService.isCompanyID(this.currentUid)) {
                ...
                this.userStoreService.getCurrentUUID((v) => {
                    if (this.currentUid == v) {
                        this.isOwner = true;
                    }
                    else {
    ...
    dealEvent() {
        this.events.subscribe(event_name_config_1.EventNameConfig.EDIT_PROFILE, (param) => {
    ...
    initAccess() {
        ...
        this.userService.fetchContactPermission(this.currentUid, (res) => {
            let num = 0;
            ...
            console.log('relation', relation, 'couldHire', couldHire, 'couldAddRelation', this.couldAddRelation, 'hasRelationship', this.hasRelationship);
            let newMenuArr = [];
    ...
    getContactDetail() {
         ...
         */
        this.userService.fetchContactDetailInfo(this.currentUid, this.activeModule, (res) => {
    ...
    onClickChat(event) {
        ...
        let modal = this.modalCtrl.create(chat_content_1.ChatContentComponent, { data: this.contact });
        modal.present();
    }
    /**
     *
    ...
    editProfile(event) {
        event.stopPropagation();
        let modal = this.modalCtrl.create(edit_profile_1.EditProfilePage, { data: this.clone(this.contact) });
        modal.present();
    }
    /**
    ...
    addFriend(comp) {
        ...
        if (this.couldAddRelation) {
            ...
            let modal = this.modalCtrl.create(contact_add_friend_1.ContactAddFriendPage, { data: this.contact, friendType: type });
            modal.present();
        }
    }
    /**
 ...
 */
let ContactCompanyIntroComponent = class ContactCompanyIntroComponent {
    constructor(userModelService, config) {
        this.userModelService = userModelService;
        this.config = config;
        this.currentUid = '';
        this.privacy = {
...
__decorate([
    core_1.Input('currentContact'),
    __metadata("design:type", Object),
    __metadata("design:paramtypes", [Object])
], ContactCompanyIntroComponent.prototype, "currentContact", null);
ContactCompanyIntroComponent = __decorate([
    core_1.Component({
        selector: 'contact-company-intro',template:/*ion-inline-start:"/Users/zhouhuan/Documents/work/blockbi-app/src/pages/contact-details/components/contact-company-intro/contact-company-intro.html"*/'<!-- Generated template for the ContactIntroComponent component -->\n<div class="contact-intro">\n  <div class="personal-general-title f7-f">BASIC INFORMATION</div>\n  <div class="personal-general-content">\n    <div class="personal-general-work-name">\n      <div class="f9-f">BUSINESS NAME</div>\n      <div class="f19-f g-max-width90">{{general.name}}</div>\n      <div class="f19-f g-no-data-color" *ngIf="general.name == \'\'">No Data</div>\n    </div>\n    <div class="personal-general-work-name">\n      <div class="f9-f">INDUSTRY</div>\n      <div class="f19-f g-max-width90">{{general.industry}}</div>\n      <div class="f19-f g-no-data-color" *ngIf="general.industry == \'\'">No Data</div>\n    </div>\n    <div class="personal-general-work-name">\n      <div class="f9-f">FOUND</div>\n      <div class="f19-f g-max-width90">{{general.found_date}}</div>\n      <div class="f19-f g-no-data-color" *ngIf="general.found_date == \'\'">No Data</div>\n    </div>\n    <div class="personal-general-work-name">\n      <div class="f9-f">CURRENT STAFF AMOUNT</div>\n      <div class="f19-f g-max-width90">{{general.amount_employee}}</div>\n      <div class="f19-f g-no-data-color" *ngIf="general.amount_employee == -1">No Data</div>\n    </div>\n    <div class="personal-general-work-name">\n      <div class="f9-f">CURRENT DEPARTMENT AMOUNT</div>\n      <div class="f19-f g-max-width90">{{general.amount_dept}}</div>\n      <div class="f19-f g-no-data-color" *ngIf="general.amount_dept == -1">No Data</div>\n    </div>\n    <div class="personal-general-work-name">\n      <div class="f9-f">SPECIFICATION</div>\n      <div class="f19-f g-max-width90">{{general.description}}</div>\n      <div class="f19-f g-no-data-color" *ngIf="general.description == \'\'">No Data</div>\n    </div>\n    <div class="personal-general-title f7-f">PRIVACY INFORMATION</div>\n    <div class="personal-general-content">\n      <div class="personal-general-work-name">\n        <div class="f9-f">OWNER</div>\n        <div *ngFor="let owner of privacy.owner">\n          <div class="f19-f g-max-width90">\n            <img class="g-user-profile24 pro-profile" src="{{config.resourceDomain}}{{owner.user_profile_path}}" alt="">\n            <span>{{owner.work_name}}</span>\n          </div>\n        </div>\n        <div class="f19-f g-no-data-color" *ngIf="privacy.owner.length == 0">No Data</div>\n      </div>\n      <div class="personal-general-work-name">\n        <div class="f9-f">SHARE HOLDER</div>\n        <div *ngFor="let share_holder of privacy.share_holder">\n          <div class="f19-f g-max-width90">\n            <img class="g-user-profile24 pro-profile" src="{{config.resourceDomain}}{{share_holder.user_profile_path}}" alt="">\n            <span>{{share_holder.work_name}}</span>\n          </div>\n        </div>\n        <div class="f19-f g-no-data-color" *ngIf="privacy.share_holder.length == 0">No Data</div>\n      </div>\n      <div class="personal-general-work-name">\n        <div class="f9-f">MAIN ADMIN</div>\n        <div *ngFor="let structure_admin of privacy.structure_admin">\n          <div class="f19-f g-max-width90">\n            <img class="g-user-profile24 pro-profile" src="{{config.resourceDomain}}{{structure_admin.user_profile_path}}" alt="">\n            <span>{{structure_admin.work_name}}</span>\n          </div>\n        </div>\n        <div class="f19-f g-no-data-color" *ngIf="privacy.structure_admin.length == 0">No Data</div>\n      </div>\n      <div class="personal-general-work-name">\n        <div class="f9-f">BUILDER</div>\n        <div *ngFor="let builder of privacy.builder">\n          <div class="f19-f g-max-width90">\n            <img class="g-user-profile24 pro-profile" src="{{config.resourceDomain}}{{builder.user_profile_path}}" alt="">\n            <span>{{builder.work_name}}</span>\n          </div>\n        </div>\n        <div class="f19-f g-no-data-color" *ngIf="privacy.builder.length == 0">No Data</div>\n      </div>\n      <div class="personal-general-work-name">\n        <div class="f9-f">BUSINESS ADDRESS</div>\n        <div class="f19-f g-max-width90">{{privacy.address}}</div>\n        <div class="f19-f g-no-data-color" *ngIf="privacy.address == \'\'">No Data</div>\n      </div>\n      <div class="personal-general-work-name">\n        <div class="f9-f">PARENT COMPANY</div>\n        <div class="f19-f g-max-width90">{{privacy.parent.name}}</div>\n        <div class="f19-f g-no-data-color" *ngIf="privacy.parent.name == \'\'">No Data</div>\n      </div>\n    </div>\n  </div>\n</div>\n'/*ion-inline-end:"/Users/zhouhuan/Documents/work/blockbi-app/src/pages/contact-details/components/contact-company-intro/contact-company-intro.html"*/
    }),
    __param(1, core_1.Inject('app.config')),
    __metadata("design:paramtypes", [user_model_service_1.UserModelService, Object])
], ContactCompanyIntroComponent);
exports.ContactCompanyIntroComponent = ContactCompanyIntroComponent;
//# sourceMappingURL=contact-company-intro.js.map
...
const core_1 = __webpack_require__(0);
/**
 * Generated class for the ContactCompanyAnalysisComponent component.
 *
 * See https://angular.io/docs/ts/latest/api/core/index/ComponentMetadata-class.html
 * for more info on Angular Components.
 */
let ContactCompanyAnalysisComponent = class ContactCompanyAnalysisComponent {
    constructor() {
        console.log('Hello ContactCompanyAnalysisComponent Component');
    }
};
ContactCompanyAnalysisComponent = __decorate([
    core_1.Component({
        selector: 'contact-company-analysis',template:/*ion-inline-start:"/Users/zhouhuan/Documents/work/blockbi-app/src/pages/contact-details/components/contact-company-analysis/contact-company-analysis.html"*/'<!-- Generated template for the ContactCompanyAnalysisComponent component -->\n<div class="g-margin-left10">\n  <div class="g-margin-top20">\n    <img src="../../../../assets/image/personal-analysis-img.jpg" style="width: 250px;" alt="">\n  </div>\n</div>\n'/*ion-inline-end:"/Users/zhouhuan/Documents/work/blockbi-app/src/pages/contact-details/components/contact-company-analysis/contact-company-analysis.html"*/
    }),
    __metadata("design:paramtypes", [])
], ContactCompanyAnalysisComponent);
exports.ContactCompanyAnalysisComponent = ContactCompanyAnalysisComponent;
//# sourceMappingURL=contact-company-analysis.js.map
...
const user_model_service_1 = __webpack_require__(57);
const personal_model_service_1 = __webpack_require__(364);
const SKILL_LEVEL = ['Elementary level', 'Limited working level', 'Professional level', 'Native level'];
const SKILL_LEVEL_ZH = ['基础等级', '限于工作', '专业等级', '国家级别'];
/**
 ...
 * for more info on Angular Components.
 */
let ContactPersonalAnalysisComponent = class ContactPersonalAnalysisComponent {
    constructor(userModelService, config, personalModelService) {
        this.userModelService = userModelService;
        this.config = config;
        this.personalModelService = personalModelService;
        this.currentUid = '';
    ...
    getSkillJson() {
        ...
        if (!this.skillNameList) {
            this.personalModelService.queryJson('GET', 'assets/json/skill.json', '', (data) => {
...
__decorate([
    ...
    __metadata("design:type", Object),
    __metadata("design:paramtypes", [Object])
], ContactPersonalAnalysisComponent.prototype, "currentContact", null);
ContactPersonalAnalysisComponent = __decorate([
    core_1.Component({
        selector: 'contact-personal-analysis',template:/*ion-inline-start:"/Users/zhouhuan/Documents/work/blockbi-app/src/pages/contact-details/components/contact-personal-analysis/contact-personal-analysis.html"*/'<!-- Generated template for the ContactPersonalAnalysisComponent component -->\n<div>\n  <div class="personal-general-title f7-f">SKILL</div>\n  <div class="g-margin-left10">\n    <div *ngFor="let skill of skillList">\n      <div class="f19-f">{{skillNameList[skill.skill_name - 1].name}}</div>\n      <div class="f19-f" style="color: #eee;">{{skillLevel[skill.level - 1]}}</div>\n\n      <div class="intro-slide-wrap" slidesSkill>\n        <ion-slides slidesPerView = \'5\' spaceBetween = \'10\' #slides>\n          <ion-slide *ngFor="let like of skill.likeUsers">\n            <img class="g-user-profile24" src="{{config.resourceDomain}}{{like.user_profile_path}}" alt="">\n          </ion-slide>\n        </ion-slides>\n        <div class="intro-slide-prev intro-slide-btn bi-icon-down" #prev>\n        </div>\n        <div class="intro-slide-next intro-slide-btn bi-icon-down" #next>\n        </div>\n      </div>\n    </div>\n    <div class="g-margin-top20">\n      <img src="../../../../assets/image/personal-analysis-img.jpg" style="width: 250px;" alt="">\n    </div>\n  </div>\n</div>\n'/*ion-inline-end:"/Users/zhouhuan/Documents/work/blockbi-app/src/pages/contact-details/components/contact-personal-analysis/contact-personal-analysis.html"*/,
        providers: [personal_model_service_1.PersonalModelService]
    }),
    __param(1, core_1.Inject('app.config')),
    __metadata("design:paramtypes", [user_model_service_1.UserModelService, Object, personal_model_service_1.PersonalModelService])
], ContactPersonalAnalysisComponent);
exports.ContactPersonalAnalysisComponent = ContactPersonalAnalysisComponent;
//# sourceMappingURL=contact-personal-analysis.js.map
 ...
 * for more info on Angular Components.
 */
let ContactResumeComponent = class ContactResumeComponent {
...
__decorate([
    ...
    __metadata("design:type", Object),
    __metadata("design:paramtypes", [Object])
], ContactResumeComponent.prototype, "currentContact", null);
ContactResumeComponent = __decorate([
    core_1.Component({
        selector: 'contact-resume',template:/*ion-inline-start:"/Users/zhouhuan/Documents/work/blockbi-app/src/pages/contact-details/components/contact-resume/contact-resume.html"*/'<!-- Generated template for the ContactResumeComponent component -->\n\n<div>\n    <div class="personal-resume-content">\n        <div class="personal-general-title f7-f">EDUCATION</div>\n        <div class="g-margin-left10">\n            <div *ngFor="let education of educations">\n                <div class="personal-general-work-name">\n                    <div class="f9-f">PERIOD</div>\n                    <div class="f19-f g-max-width90">{{education.start_date}}<span class="bi-icon-arrow3 g-arrow"></span> {{education.end_date}}</div>\n                    <div class="f19-f g-no-data-color" *ngIf="education.start_date == \'\' && education.end_date == \'\'">No Data</div>\n                </div>\n                <div class="personal-general-work-name">\n                    <div class="f9-f">SCHOOL</div>\n                    <div class="f19-f g-max-width90">{{education.school}}</div>\n                    <div class="f19-f g-no-data-color" *ngIf="education.school == \'\'">No Data</div>\n                </div>\n                <div class="personal-general-work-name">\n                    <div class="f9-f">MAJOR</div>\n                    <div class="f19-f g-max-width90">{{education.major}}</div>\n                    <div class="f19-f g-no-data-color" *ngIf="education.major == \'\'">No Data</div>\n                </div>\n                <div class="personal-general-work-name">\n                    <div class="f9-f">SPECIFICATION</div>\n                    <div class="f19-f g-max-width90">{{education.description}}</div>\n                    <div class="f19-f g-no-data-color" *ngIf="education.description == \'\'">No Data</div>\n                </div>\n            </div>\n            <div class="f19-f g-no-data-color personal-general-phone personal-general-work-name" *ngIf="educations.length == 0">No Data</div>\n        </div>\n\n        <div class="personal-general-title f7-f">EXPERIENCE</div>\n        <div class="g-margin-left10">\n            <div *ngFor="let experience of experiences">\n                <div class="personal-general-phone personal-general-work-name">\n                    <div class="f9-f">PERIOD</div>\n                    <div class="f19-f g-max-width90">{{experience.start_date}} <span class="bi-icon-arrow3 g-arrow"></span> {{experience.end_date}}</div>\n                    <div class="f19-f g-no-data-color" *ngIf="experience.start_date == \'\' && experience.end_date == \'\'">No Data</div>\n                </div>\n                <div class="personal-general-phone personal-general-work-name">\n                    <div class="f9-f">COMPANY</div>\n                    <div class="f19-f g-max-width90">{{experience.company}}</div>\n                    <div class="f19-f g-no-data-color" *ngIf="experience.company == \'\'">No Data</div>\n                </div>\n                <div class="personal-general-phone personal-general-work-name">\n                    <div class="f9-f">INITIAL POSITION</div>\n                    <div class="f19-f g-max-width90">{{experience.initial_position}}</div>\n                    <div class="f19-f g-no-data-color" *ngIf="experience.initial_position == \'\'">No Data</div>\n                </div>\n                <div class="personal-general-phone personal-general-work-name">\n                    <div class="f9-f">LAST POSITION</div>\n                    <div class="f19-f g-max-width90">{{experience.finial_position}}</div>\n                    <div class="f19-f g-no-data-color" *ngIf="experience.finial_position == \'\'">No Data</div>\n                </div>\n                <div class="personal-general-phone personal-general-work-name">\n                    <div class="f9-f">SPECIFICATION</div>\n                    <div class="f19-f g-max-width90">{{experience.description}}</div>\n                    <div class="f19-f g-no-data-color" *ngIf="experience.description == \'\'">No Data</div>\n                </div>\n            </div>\n            <div class="f19-f g-no-data-color personal-general-phone personal-general-work-name" *ngIf="experiences.length == 0">No Data</div>\n        </div>\n\n    </div>\n</div>\n'/*ion-inline-end:"/Users/zhouhuan/Documents/work/blockbi-app/src/pages/contact-details/components/contact-resume/contact-resume.html"*/
    }),
    __metadata("design:paramtypes", [user_model_service_1.UserModelService])
], ContactResumeComponent);
exports.ContactResumeComponent = ContactResumeComponent;
//# sourceMappingURL=contact-resume.js.map
 ...
 * for more info on Angular Components.
 */
let ContactGeneralComponent = class ContactGeneralComponent {
    constructor(userModelService, modalCtrl) {
        this.userModelService = userModelService;
        this.modalCtrl = modalCtrl;
        this.company = [];
        this.individual = {};
     ...
     * 添加Cooperator好友
     */
    addNewCooperator(event, cp) {
        event.stopPropagation();
        cp.psid = cp.uid;
        let modal = this.modalCtrl.create(contact_add_friend_1.ContactAddFriendPage, { data: cp, friendType: 2 });
        modal.present();
    }
};
__decorate([
    ...
    __metadata("design:type", Object),
    __metadata("design:paramtypes", [Object])
], ContactGeneralComponent.prototype, "currentContact", null);
ContactGeneralComponent = __decorate([
    core_1.Component({
        selector: 'contact-general',template:/*ion-inline-start:"/Users/zhouhuan/Documents/work/blockbi-app/src/pages/contact-details/components/contact-general/contact-general.html"*/'<!-- Generated template for the ContactGeneralComponent component -->\n<div>\n    <div class="personal-general-title f7-f">INDIVIDUAL INFORMATION</div>\n    <div class="personal-general-content">\n        <div class="personal-general-work-name">\n            <div class="f9-f">WORK NAME</div>\n            <div class="f19-f g-max-width90">{{individual.work_name}}</div>\n            <div class="f19-f g-no-data-color" *ngIf="individual.work_name == \'\'">No Data</div>\n        </div>\n        <div class="personal-general-phone personal-general-work-name">\n            <div class="f9-f">PERSONAL PHONE</div>\n            <div class="f19-f g-max-width90">{{individual.phone}}</div>\n            <div class="f19-f g-no-data-color" *ngIf="individual.phone == \'\'">No Data</div>\n        </div>\n        <div class="personal-general-job personal-general-work-name">\n            <div class="f9-f">CURRENT JOB</div>\n            <div *ngFor="let cp of company" class="f19-f">\n\n                <div class="g-max-width90">{{cp.company_name}}</div>\n                <div class="g-max-width90">\n                    <span *ngIf="cp.could_add && !isOwner"\n                          (click)="addNewCooperator($event,cp)"\n                          class="bi-icon-shape1 add-friend"></span>\n                    {{cp.p_name}}\n                </div>\n            </div>\n            <div *ngIf="(!noCompany && company.length == 0) || (noCompany && !individual.p_name)" class="f19-f g-no-data-color">\n                No Data\n            </div>\n            <div *ngIf = \'noCompany\' class="g-max-width90">{{individual.p_name}}</div>\n        </div>\n    </div>\n\n</div>\n'/*ion-inline-end:"/Users/zhouhuan/Documents/work/blockbi-app/src/pages/contact-details/components/contact-general/contact-general.html"*/
    }),
    __metadata("design:paramtypes", [user_model_service_1.UserModelService,
        ionic_angular_1.ModalController])
], ContactGeneralComponent);
exports.ContactGeneralComponent = ContactGeneralComponent;
//# sourceMappingURL=contact-general.js.map
